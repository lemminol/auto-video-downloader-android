...
public final class EndpointManager {
    ...
    public String getLocalEndpoint() { return prefs.getString("local", "http://192.168.50.242:8792"); }
    ...
    private boolean probePath(String endpoint, String path, boolean requireIdentity) {
        ...
        try {
            ...
            conn.setRequestProperty("User-Agent", "AVD-Android/1.1");
    ...
    public static String normalizeEndpoint(String raw, boolean localAllowed) {
        ...
        if (!value.matches("^[A-Za-z][A-Za-z0-9+.-]*://.*$")) value = (localAllowed ? "http://" : "https://") + value;
        try {
